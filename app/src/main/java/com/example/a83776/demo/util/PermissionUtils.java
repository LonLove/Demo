...
public class PermissionUtils {
    ...
    private static final String[] requestSDPermissions = {
            PERMISSION_READ_EXTERNAL_STORAGE,
            PERMISSION_WRITE_EXTERNAL_STORAGE
    };
    ...
    public interface PermissionGrant {
        ...
        void onPermissionNoGranted(int requestCode);
...
//        }
    ...
    private static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
        ...
        if (notGranted.size() == 0) {
            ...
            openSettingActivity(activity, "请授权!");
            permissionGrant.onPermissionNoGranted(CODE_MULTI_PERMISSION);
        }
     ...
     * 一次申请SD读写权限
     */
    public static void requestMultiSDPermissions(final Activity activity, PermissionGrant grant) {

        final List<String> permissionsList = getNoGrantedSDPermission(activity, false);
        final List<String> shouldRationalePermissionsList = getNoGrantedSDPermission(activity, true);
        ...
        if (permissionsList.size() > 0) {
            ...
            /*showMessageOKCancel(activity, "正在请求SD读写权限",
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
     ...
     * @return
     */
    public static ArrayList<String> getNoGrantedSDPermission(Activity activity, boolean isShouldRationale) {

        ArrayList<String> permissions = new ArrayList<>();

        for (int i = 0; i < requestSDPermissions.length; i++) {
            String requestPermission = requestSDPermissions[i];
