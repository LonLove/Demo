package com.example.a83776.demo.widget.nicevideoplayer;
...
public class MyVideoPlayerController
    ...
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.my_video_palyer_controller, this, true);
    ...
    protected void onPlayModeChanged(int playMode) {
        switch (playMode) {
            ...
            case NiceVideoPlayer.MODE_FULL_SCREEN:
                ...
                if(Config.VERSION_TYPE == 1){//电视不显示电池
...
//                mBatteryTime.setVisibility(View.VISIBLE);
    ...
    protected void updateProgress() {
        ...
        if(onPlayVideoProgress != null){
            onPlayVideoProgress.onProgress(duration,position);
        }
    }
    ...
    OnPlayVideoProgress onPlayVideoProgress;

    public void setOnPlayVideoProgress(OnPlayVideoProgress onPlayVideoProgress){
        this.onPlayVideoProgress = onPlayVideoProgress;
    }

    public interface OnPlayVideoProgress{
        void onProgress(long duration, long position);
    }
}
