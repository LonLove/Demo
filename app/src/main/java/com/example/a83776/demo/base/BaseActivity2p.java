 ...
 */
public abstract class BaseActivity2p<T extends BasePresenter,V extends BasePresenter> extends FragmentActivity implements BaseView {

    private View mView;
    @Inject
    protected T mPresenter;
    @Inject
    protected V mPresenter1;
