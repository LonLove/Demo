...
package com.example.a83776.netease.thirdparty.video;
...
import com.netease.neliveplayer.sdk.NELivePlayer.OnBufferingUpdateListener;
...
public class NEVideoView extends SurfaceView implements NEVideoController.MediaPlayerControl{
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mUri != null) {
            	neMediaPlayer = NELivePlayer.create(mContext);
